...
| Auditor | Findings | Key Fixes |
|---|---|---|
| Hashlock | Audited | Liquidation min debt removed, vault donation fallback, dust collateral handling |
| BlockBite | Audited | MasterChef decimal check added, burnFrom uses OZ _spendAllowance |
